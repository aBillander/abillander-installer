    ...
    <form class="" action="{{ route('installer::configuration') }}" method="post">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>{{ __('installer::main.config.text') }}</p>
                <hr>
                <div class="form-group">
                    <p class="lead">{{ __('installer::main.config.database.title') }}</p>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="control-label" for="inputDefault">{{ __('installer::main.config.database.host') }}</label><br>
                            <input type="text" name="DB_HOST" class="form-control" value="{{ config('database.connections.mysql.host') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="control-label" for="inputDefault">{{ __('installer::main.config.database.port') }}</label><br>
                            <input type="text" name="DB_PORT" class="form-control" value="{{ config('database.connections.mysql.port') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="control-label" for="inputDefault">{{ __('installer::main.config.database.name') }}</label><br>
                            <input type="text" name="DB_DATABASE" class="form-control" value="{{ config('database.connections.mysql.database') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="control-label" for="inputDefault">{{ __('installer::main.config.database.login') }}</label><br>
                            <input type="text" name="DB_USERNAME" class="form-control" value="{{ config('database.connections.mysql.username') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="control-label" for="inputDefault">{{ __('installer::main.config.database.password') }}</label><br>
